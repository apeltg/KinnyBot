...
module.exports = {
    ...
    run: async (client, message) => {
        ...
        const re = []
        const collector = message.channel.createMessageCollector({filter: ({ author }) => author.id === (message.user.id), max: per.length})
