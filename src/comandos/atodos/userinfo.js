...
module.exports = {
    ...
    run: async(client, message, args) => {
            ...
            let membro = message.mentions?.members.first() || message.guild.members.cache.get(!id ? !message.author ? message.user.id:message.author.id:id.replace(/[<@!>]/g, '')) || await message.guild.members.fetch(!id ? !message.author ? message.user.id:message.author.id:id.replace(/[<@!>]/g, ''));
