...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!lan) {
            if (message.mentions.users.first() || client.users.cache.get(!args[0] ? message.options?.getString('vitima').replace(/[<@!>]/g, ''):args[0])) {
                if (!lan) {
                    ...
                    if (pc.cooldown + 3.6e+6 > Date.now()) {
                        ...
                        message.reply({content: message.author.toString(), embeds: [embed]}).then(editar => {
                            ...
                            setTimeout(async () => {
                                ...
                                editar.edit({content: message.author.toString(), embeds: [embed]})
                            }, 5000)
                        })
                    }
                } else {
